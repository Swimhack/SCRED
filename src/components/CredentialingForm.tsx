...
const CredentialingForm = () => {
  ...
  // Simple single-page form for MVP
  const SimplifiedForm = () => (
    <div className="bg-white rounded-lg shadow-sm border p-6 max-w-4xl mx-auto">
      <div className="mb-6">
        <h2 className="text-2xl font-semibold">Pharmacist Credentialing Application</h2>
        {featureFlags.isMvp && (
          <p className="text-sm text-blue-600 mt-1">MVP Mode - Simplified single-page form</p>
        )}
      </div>
      ...
      <div className="space-y-8">
        ...
        {/* Education & Training */}
        <div>
          <h3 className="text-lg font-medium mb-4 pb-2 border-b">Education & Training</h3>
        ...
        <div>
          <h3 className="text-lg font-medium mb-4 pb-2 border-b">License & Certifications</h3>
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
        ...
        <div>
          <h3 className="text-lg font-medium mb-4 pb-2 border-b">Practice Information</h3>
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
        ...
        <div className="flex justify-center pt-6 border-t">
          <Button 
            ...
            className="bg-brand-primary text-primary-foreground hover:bg-brand-primary/90 px-8"
          >
            Submit Application
          </Button>
        </div>
  ...
  // Return appropriate form based on feature flags
  if (featureFlags.applications.multiStepWizard === false) {
