    ...
    <div className={cn(
      ...
      <div className="p-4 flex items-center justify-between border-b">
        <div className={cn("flex items-center", collapsed ? "justify-center w-full" : "")}>
          {!collapsed && <h2 className="font-bold text-xl">PharmCred</h2>}
          {collapsed && <div className="w-8 h-8 bg-brand-primary rounded-full flex items-center justify-center">P</div>}
        </div>
        <button 
